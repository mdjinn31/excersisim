...
export function fixListOfWagons(ids) {
  const [fisrt, second, ...restOfWagons] = ids
  return [...restOfWagons,fisrt,second]
}
...
export function correctListOfWagons(ids, missingWagons) {
  const [first, ...restIdWagons] = ids
  return [first, ...missingWagons, ...restIdWagons]
}
...
export function separateTimeOfArrival(information) {
  const {timeOfArrival, ...restOfInformation} = information
  return [timeOfArrival, restOfInformation]
}
