...
export function isEmptyArray(value) {
  return !isNonEmptyArray(value) && Array.isArray(value)
}
...
export function assertHasId(object) {
  if (!("id" in object)) throw new Error('Object has no ID')
}
...
export function hasDefinedType(object) {
  return ((object.type !== undefined) && (Object.hasOwn(object, "type")))
}
