 ...
 */
export const canSignalPrisoner = (archerIsAwake, prisonerIsAwake) => prisonerIsAwake  && !(prisonerIsAwake && archerIsAwake)
...
export function canFreePrisoner(
  ...
  return (!archerIsAwake && petDogIsPresent && knightIsAwake) 
